...
export default function PlayerClient({ initialPlaylist }: { initialPlaylist: Playlist }) {
    const [playlistUrl, setPlaylistUrl] = useState<string | string[]>('https://iptv-org.github.io/iptv/countries/fr.m3u');
    ...
    useEffect(() => {
        // Only load if url changes from default or if we want to ensure fresh data
        if (playlistUrl !== 'https://iptv-org.github.io/iptv/countries/fr.m3u' || playlist.channels.length === 0) {
